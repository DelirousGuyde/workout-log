...
## Purpose
Use this checklist at the start of any session (Claude Code or Codex CLI) to catch time-based reminders and required updates. If an item applies, surface it immediately before proceeding with other work.

## Time-Based Reminders
- Review `state.md` on or after 2026-03-01 (PT) and confirm whether it needs updates.
